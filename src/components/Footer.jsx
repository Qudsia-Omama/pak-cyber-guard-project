      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted partner in fighting cybercrime. We provide a secure, professional platform 
              for reporting cyber incidents and promoting digital safety awareness.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/awareness" className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
                  Awareness
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                <span className="text-red-400">🚨</span> Cyber Crime: 1930
              </li>
              <li className="text-gray-400">
                <span className="text-blue-400">📞</span> Police: 100
              </li>
              <li className="text-gray-400">
                <span className="text-green-400">💬</span> Consumer: 1915
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Pak Cyber Guard. All rights reserved.
          </p>
