      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400">
            Sign in to your Pak Cyber Guard account
          </p>
        </div>
        ...
        {/* Security Notice */}
        <div className="glow-card text-center bg-blue-900 bg-opacity-20 border-blue-500">
          <div className="text-2xl mb-2">🔐</div>
          <h3 className="font-semibold mb-2">Your Security Matters</h3>
          <p className="text-sm text-gray-400">
            We use advanced encryption and security measures to protect your account and personal information.
          </p>
        </div>
      </div>
    </div>
